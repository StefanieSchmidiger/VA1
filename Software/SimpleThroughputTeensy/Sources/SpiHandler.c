...
static xQueueHandle TxWirelessBytes[4]; /* Incoming data from wireless side stored here */
static xQueueHandle RxWirelessBytes[4]; /* Outgoing data to wireless side stored here */
static xQueueHandle TxDeviceBytes[4]; /* Incoming data from device side stored here */
static xQueueHandle RxDeviceBytes[4];  /* Outgoing data to device side stored here */
