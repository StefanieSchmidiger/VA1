...
\vspace{2mm}
\huge\textbf{HSLU Elektrotechnik Master}\\     			     %%% Titel der Arbeit 2. Zeile
\vspace{8mm}
...
{Erich Styger}                          	       		%%% Advisor
{Der Experte}                                   		%%% Experte
{Horw}                                          		 	%%% Ort
{2017}                                         		 		%%% Jahr XXXX
{10.01.}                                       		 		%%% Tag und Monat der Selbstständigkeitserklärung XX.XX.
{Version 0 & Vorabzug & 01.09.14 & Stefanie Schmidiger}    	%%% Änderungsverzeichnis, für neue linie \\
...
{\input{content/02_Introduction}} % Text der Kurzfassung in Deutsch
...
\input{content/03_StartingSituation}%
%
\chapter{Starting Situation}%
\input{content/04_ExistingWork}%
%
\chapter{Hardware}%
\input{content/05_Hardware}%
%
\chapter{Software}%
\input{content/06_Software}%
%
\chapter{Testing}%
\input{content/07_Testing}%
%
%
%
%
...
\input{content/100_Hyperref}%
%
\chapter{Literaturverweise}%
\input{content/101_Literaturverweise}%
